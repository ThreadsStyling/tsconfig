...
module.exports = (options) => {
  if (typeof options?.internalRegex !== 'string') {
    throw new Error(`Expected options.internalRegex to be a string`);
  }
  return {
    extends: [],
    ...
    settings: {
      ...
      'import/internal-regex': options.internalRegex, // 'rollingversions',
